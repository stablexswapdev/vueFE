...
// TO update the number of pools supported
var N_COINS = 2;

// TO Update: the relevant swapping address and LP tokens.
...
// TO check what migration is
var migration_address = '0x54Ee22d5593FC76fB20EafAb66C45aAb3268B800';
export const infura_url = 'https://data-seed-prebsc-1-s2.binance.org:8545';
...
export async function init(contract, refresh = false) {
	...
	try {
        ...
        if(networkId != 56) {
            this.error = 'Error: wrong network type. Please switch to BSC mainnet (56)';
        }
    }
    catch(err) {
        console.error(err);
...
// Integrates CHI, which is not yet available on BSC

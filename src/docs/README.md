...
[stablexswap.com DAI/USDC/USDT LP Token](https://etherscan.io/address/0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490)
...
URL: https://stablexswap.com/raw-stats/{ **compound, usdt, y, busd, susd, pax, ren2, rens, hbtc, 3pool, gusd, husd, usdk, usdn** }-{ **1, 5, 10, 30, 1440** }m.json
for example https://stablexswap.com/raw-stats/compound-5m.json
...
[Get all pools](http://pushservice.stablexswap.com/pools)

Get APYs for a pool(all currencies in a pool have same APY)

http://pushservice.stablexswap.com/apys/:pool
For example http://pushservice.stablexswap.com/apys/susdv2

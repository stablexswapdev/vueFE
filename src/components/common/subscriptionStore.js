...
export async function subscribeNotifications() {
	let swregistration = await navigator.serviceWorker.ready
	let response = await fetch('https://pushservice.stablexswap.com/vapidPublicKey');
...
export async function unsubscribeNotifications() {
	...
	await fetch('https://pushservice.stablexswap.com/removeSubscription', {
		method: 'POST',
		headers: {
...
export async function updateSubscriptionServer(newSubscription) {
	...
	await fetch('https://pushservice.stablexswap.com/updateSubscription', {
		method: 'POST',
		headers: {
			'Content-type': 'application/json',
		},
...
export async function registerSubscription(subscription) {
	await fetch('https://pushservice.stablexswap.com/register', {
		method: 'post',
		headers: {
		  'Content-type': 'application/json'
		},
...
export async function postTxNotification(txHash) {
	...
	return fetch('https://pushservice.stablexswap.com/addtx', 
		{
		    method: 'POST', 
		    headers: {
		      'Content-type': 'application/json'
...
export async function removeTxNotification(txHash) {
	...
	console.log(subscription)
	if(subscription === null) return;
	return fetch('https://pushservice.stablexswap.com/removetx',
		{
			method: 'POST',
			headers: {
				'Content-type': 'application/json',

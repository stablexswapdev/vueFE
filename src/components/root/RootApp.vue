      ...
      <div class='poolsdropdown'>
        ...
        <div class='dropdown'>
           <!--  <a :href="'//compound.localhost:8080'+$route.path" :class="{selected: currentPool == 'compound'}" @click="changePools('compound')">Compound</a>
            ...
            <router-link :to="'/compound/' + ($route.path.split('/')[2] || '')  ">Interest Bearing Coming Soon</router-link>
...
<!--             <a href="https://iearn.finance/pool">sUSD</a> -->
      ...
      <a href="">Governance Coming Soon</a>
      ...
      <div class='poolsdropdown right'>
        ...
        <div class='dropdown'>
          ...
          <p>____________</p>
          <a href="https://twitter.com/stablexswap" rel='noopener noreferrer'>#Twitter</a>
          <a href="https://t.me/stablexswapofficial" rel='noopener noreferrer'>@Telegram</a>
          <a href="https://t.me/stablexswap_ann" rel='noopener noreferrer'>@Telegram Announcements</a>
         <p>____________</p>
          <a href="https://github.com/stablexlabs">git@</a>
        </div>
      </div>
      <a href="https://dao.stablexswap.com" class='showmobile'>DAO</a>
      ...
      <a href='https://guides.stablexswap.com' rel='noopener noreferrer' class='showmobile'>Guides</a>
...
<script>
  ...
  export default {
    metaInfo: {
      title: 'stablexswap.com',
      meta: [
        {'property': 'og:title', 'content': 'stablexswap.com'},
        {'property': 'og:url', 'content': 'https://stablexswap.com'},
        ...
        {'name': 'twitter:title', 'content': 'stablexswap.com'},
        ...
        {'name': 'twitter:url', 'content': 'https://stablexswap.com'},

<template>
	...
	<div class="window white">
        <h2>Curve FAQ</h2>
        <h3>What is Curve?</h3>
        <a href='https://www.stablexswap.com/stableswap-paper.pdf'>Whitepaper</a>
        <p>
            ...
            <p>
                <a href='https://www.youtube.com/watch?v=1SN7zKlb5pk' rel='noopener noreferrer'>How stablexswap.com works</a>
            </p>

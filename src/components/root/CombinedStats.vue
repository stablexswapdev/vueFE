<template>
	<div>
		...
		<div class="window white" v-for='(currency, i) in Object.keys(filteredCurrencies)'>
		      ...
		      <p class='text-center'>
		      	<router-link :to="currency" v-show="currency != 'susd' && !['tbtc', 'ren', 'sbtc'].includes(currency)">{{currency == 'iearn' ? 'y' : currency}}.stablexswap.com</router-link>
...
<script>
	...
	export default {
		metaInfo: {
	      title: 'stablexswap.com - Stats',
	      meta: [
	      	{'property': 'og:url', 'content': 'https://stablexswap.com/combinedstats'},
	      	{'name': 'twitter:url', 'content': 'https://stablexswap.com/combinedstats'},
	      ]
	    },
		components: {
			Stats,

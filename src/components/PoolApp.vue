  ...
  <div id="app">
    <div class='screencontainer'>
     <div class="top-menu-bar">
      ...
      <a href="https://dao.stablexswap.com">DAO</a>
      ...
      <div class='poolsdropdown right'>
        ...
        <div class='dropdown'>
          ...
          <a href='https://guides.stablexswap.com' rel='noopener noreferrer'>Guides</a>
          <p>____________</p>
...
<script>
  ...
  export default {
    metaInfo() {
      return {
        title: 'stablexswap.com :: ' + titles[this.currentPool],
      }
    },
    data: () => ({
      gitBranches: {

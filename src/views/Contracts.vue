	...
	<div class="window white">
	        <fieldset class='contractsdialog'>
	            ...
	            <div v-show='showContracts == 1'>
		            <fieldset>
		            	<legend>StableXswap Pool Contracts</legend>
		             <p>To-Do</p>
		            </fieldset>
		            <fieldset>
...
<script>
	...
	export default {
		...
		metaInfo: {
	      title: 'stablexswap.com :: Contracts',
	      meta: [
	        {'property': 'og:title', 'content': 'beta.stablexswap.com/contracts'},
	        {'property': 'og:url', 'content': 'https://stablexswap.com/contracts'},
	        ...
	        {'name': 'twitter:title', 'content': 'beta.stablexswap.com/contracts'},
	        ...
	        {'name': 'twitter:url', 'content': 'https://stablexswap.com/contracts'},

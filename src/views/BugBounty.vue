	...
	<div class="window white">
        <fieldset>
            ...
            <div>
                ...
                <div class='description'>
                    <div>
                        <span class='low'>Low:</span> TBD
                    </div>
                    <div>
                        <span class='medium'>Medium:</span> TBD
                    </div>
                    <div>
                        <span class='high'>High:</span> TBD
                    </div>
                    <div>
                        <span class='veryhigh'>Very high:</span> TBD
                    </div>
                </div>
            </div>
            <div>

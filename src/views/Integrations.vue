...
<script>
	export default {
		metaInfo: {
	      title: 'stablexswap.com :: Integrations',
	      meta: [
	        {'property': 'og:title', 'content': 'stablexswap.com/integrations'},
	        {'property': 'og:url', 'content': 'https://stablexswap.com/integrations'},
	        ...
	        {'name': 'twitter:title', 'content': 'stablexswap.com/integrations'},
	        ...
	        {'name': 'twitter:url', 'content': 'https://stablexswap.com/integrations'},
